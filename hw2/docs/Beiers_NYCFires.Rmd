...
NYC Open Data also provides data on the [location of all 218 Fire Stations in NYC](https://data.cityofnewyork.us/Public-Safety/FDNY-Firehouse-Listing/hc8x-tcnd). Relevant for our analyses are the following variables:
...
content <- paste("<b>What:</b>",fire$INCIDENT_TYPE_DESC,"<br/>",
                 ...
                 "<b>Fire Dectector Status</b>:", fire$Latitude, "<br/>",
                 "<b>Fire Dectector Status</b>:", fire$Longitude, "<br/>")
...
### 4. Distance from Fire Station and Response Time
...
map_zip <- get_map("New York City", zoom=10, 
