...
test <- retweets %>% 
  ...
  ungroup()
test <- spread(test, rt_user_party, len)
test[is.na(test)] <- 0
...
colnames(test)[3] <- "Democrat"
colnames(test)[5] <- "Republican"


# scatter plot
ggplot(data = test2, aes(x = Ind.Dem, y = Ind.Rep, color = user_party)) +
  geom_point() +
  ...
  geom_label_repel(data = test2[test2$Republican > 6000|test2$Democrat > 6000|test2$Independent < -500,],
                   aes(label = screen_name), 
                    size = 2, color = "black") +
  ggplot2::annotate(geom = "text", x = 12500, y = 10000,  # right arrow
                    label = "More Dem RTs", size = 3) +
  geom_segment(aes(x = 10000, xend = 12500 , y = 9000, yend = 9000),
                     arrow = arrow(length = unit(0.2,"cm")), color = "blue") +
  ggplot2::annotate("text", x = 7000, y = 10000,  # left arrow
                    label = "More Ind RTs",
                    size = 3) +
        geom_segment(aes(x = 10000, xend = 7500 , y = 9000, yend = 9000),
                     arrow = arrow(length = unit(0.2,"cm")), color = "yellow") +
  ggplot2::annotate("text", x = 10000, y = 5000,  # down arrow
                    label = "More Ind RTs",  
                    size = 3) +
        geom_segment(aes(x = 10000, xend = 10000 , y = 9000, yend = 6000),
                     arrow = arrow(length = unit(0.2,"cm")), color = "yellow") +
  ggplot2::annotate("text", x = 10000, y = 12500,  # up arrow
                    label = "More Rep RTs",  
                    size = 3) +
        geom_segment(aes(x = 10000, xend = 10000 , y = 9000, yend = 12000),
