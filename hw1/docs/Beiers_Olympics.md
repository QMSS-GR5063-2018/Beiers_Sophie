...
Combine the information in the two spreadsheets `winter.csv` and `dictionary.csv`. Because some [countries that competed under different designations in the past (e.g. Germany and Russia)](https://en.wikipedia.org/wiki/All-time_Olympic_Games_medal_table), I chose to combine Russia with URS, Germany with EUA, FRG and GDR, and Czech Republic with TCH.
...
![Medals Over Time](../fig/olympmeds.png)
